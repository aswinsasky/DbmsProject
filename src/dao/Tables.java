...
public class Tables {
    public static void main(String[] args) {
        ...
        st.executeUpdate("insert into appuser(userRole,name,dob,mobileNumber,email,username,password,address)values('Admin','Admin','16-12-1992','956565656','admindin@gmail.com','admin','admin','India')");
